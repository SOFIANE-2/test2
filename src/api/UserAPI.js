...
export const fetchUsersAPI = async () => {
  try {
    const response = await axios.get('https://670ed5b73e7151861655eaa3.mockapi.io/Stagiaire');  // Remplacer par la vraie URL
    return response.data;  // Assurez-vous que cette ligne renvoie bien les données
  } catch (err) {
